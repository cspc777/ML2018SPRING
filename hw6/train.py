...
users, movies, rating = readtrainingData(str(sys.argv[1]))
...
early_stopping = EarlyStopping(monitor='val_rmse', patience=1)
model.fit([users, movies], rating, epochs=90, batch_size=512, validation_split=0.1, callbacks=[early_stopping])
